...
<li class="nav-item">
    <a class="nav-link" href="coach.php">&#8592; Back</a>
</li>
    ...
    <table class="table">
        ...
        while($row = $result->fetch_assoc()) {
            echo "<tr>
                ...
                <td>
                    <a class='btn btn-primary btn-sm' href='edit-coach.php?id=" . $row["id"] . "'>Edit</a>
                    <a class='btn btn-danger btn-sm' href='delete-coach.php?id=" . $row["id"] . "'>Delete</a>
                </td>
              </tr>";
